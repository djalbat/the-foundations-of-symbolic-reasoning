...
We would rarely say "it is true that it is raining", for example, or "it is raining is true", since the veracity of the statement would normally go without saying.
