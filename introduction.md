...
We would rarely say "it is true that it is raining", for example, or "it is raining is true".
To put it one way, the truthfullness of the statement would go without saying.
